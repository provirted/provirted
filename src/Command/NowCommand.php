...
// Keep all CLIFramework components since this command intentionally demonstrates them:
...
class NowCommand extends Command
{
    ...
    protected static $defaultDescription = 'Samples of What the CLI Lib can do';
    ...
    public function tableColored()
    {
        ...
        $table->addRow([
            ...
            "Why do some products capture widespread attention",
            99
        ]);
