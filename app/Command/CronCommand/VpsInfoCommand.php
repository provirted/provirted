...
class VpsInfoCommand extends Command {
	...
	public function execute() {
        ...
        $url = 'https://my-web-2.interserver.net/'.($module == 'quickservers' ? 'qs' : 'vps').'_queue.php';
		$curl_cmd = '';
		$servers = array();
		$ips = array();
		...
		$cmd = 'curl --connect-timeout 60 --max-time 600 -k -d module='.$module.' -d action=server_list -d servers="'.urlencode(base64_encode(gzcompress(json_encode($servers), 9))).'"  '
